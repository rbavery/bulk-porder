...
for csv in $csvs; do porder order --name "Punjab Burns {$csv}" --idlist "/home/rave/tana-spin/waves/kelsey_order/data/splitcsvs/{$csv}" --item "PSScene4Band" --boundary "/home/rave/kelsey_order/data/AOI_PunjabBurning_poly_simple.geojson" --bundle "analytic_sr_udm2,analytic_sr" --op clip harmonize email
; done  
